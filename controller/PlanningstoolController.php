...
function index()
{
    ...
    $gamesplanned = getAllplannedGames();
    //2. Geef een view weer en geef de variable met medewerkers hieraan mee
    render('Planningstool/index', $gamesplanned);
}
...
function store(){
//1. plan een nieuwe game in met de data uit het formulier en sla deze op in de database
