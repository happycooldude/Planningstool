...
define('DB_NAME', 'planningstool');     // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'Planningstool'); 			// Dit is de standaard controller waarmee de webapplictie wordt opgestart
